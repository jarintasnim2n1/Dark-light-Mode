...
const Hero = () => {
  return (
    <div >
        ...
        <div className='container flex  mx-auto px-6 py-20 md:py-24 lg:py-28  xl:py-32'>
          <div className='flex flex-col lg:flex-row  items-center gap-8 lg:gap-12 xl:gap-16 '>
            <div className='flex-1  space-y-6 lg:space-y-7'>
              <div className='space-y-4 lg:space-y-5'>
                <div className='flex items-center'>
                  <span className='bg-indigo-900 dark:bg-white rounded-full  text-amber-400 px-2  py-0.5 inline-flex  items-center text-xs font-medium mr-2'>
                    New
                  </span>
                  <h2 className='inline-block px-3 py-1.5 lg:px-4 lg:py-2 rounded-full bg-neutral-900 text-amber-400 font-medium text-sm backdrop-blur-sm border-neutral-800/50'>
                    <i className='bx bx-trending-up  flex justify-between mr-1 '></i>
                ...
                <h1 className='text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight text-neutral-900 dark:text-white '>
                 ...
                 <div className=' flex gap-3 items-center'>
                  ...
                  <div className='uppercase text-xs tracking-widest text-neutral-500 dark:text-neutral-400 font-medium'>
                    <p> Transition seamlessly</p>
                  </div>
                 </div>
                 <div className='flex flex-wrap gap-3 lg:gap-4'>
                  <button className=' rounded-lg bg-neutral-900 hover:bg-black text-white dark:bg-amber-500 dark:hover:bg-amber-600 dark:text-neutral-900 font-medium shadow-lg hover:shadow-neutral-900/20 dark:hover:shadow-amber-500/20 flex items-center transition group  px-6 py-3  lg:px-7 lg-py-3.5'>
                    <i className='bx bx-code-alt mr-2 lg:mr-3 text-lg lg:text-xl group-hover:rotate-12 transition-transform '></i>
                    <span >Start Coding</span>
                  </button>
                  <button className=' rounded-lg bg-neutral-500 hover:bg-neutral-400  dark:bg-neutral-800 dark:hover:bg-neutral-700 border-neutral-300 dark:border-neutral-700 text-neutral-900 font-medium shadow-lg dark:text-white flex items-center transition group  px-6 py-3  lg:px-7 lg-py-3.5'>
                 ...
                 <div className='flex items-center gap-3'>
                  <div className='flex -space-x-3'>
                    <img src="https://randomuser.me/api/portraits/women/21.jpg" alt="user" className='w-9 h-9 rounded-full lg:w-10 lg:h-10 border-2 border-white dark:border-neutral-900 object-cover' />
                    <img src="https://randomuser.me/api/portraits/men/12.jpg" alt="user" className='w-9 h-9 rounded-full lg:w-10 lg:h-10 border-2 border-white dark:border-neutral-900 object-cover' />
                    <img src="https://randomuser.me/api/portraits/women/24.jpg" alt="user" className='w-9 h-9 rounded-full lg:w-10 lg:h-10 border-2 border-white dark:border-neutral-900 object-cover' />
                    <span className='flex items-center justify-center w-9 h-9 rounded-full lg:h-10 lg:w-10 border-2 border-white dark:border-neutral-900 text-xs font-medium bg-amber-500' >+5K</span>
                  </div>
                  <div className='space-y-1 '>
                    ...
                    <p className='text-neutral-600 dark:text-neutral-400 text-sm'>Truested by{" "}
             ...
             <div className='flex-1  w-full'>
                    <div className='relative  flex-1'>
                      <div  className='absolute -inset-0.5 bg-gradient-to-r from-amber-500 to-indigo-900 rounded-2xl blur-xl opacity-50 animated-pulse  ' ></div>
                      <div className='relative bg-white dark:bg-neutral-900 p-4 lg:p-5 xl:p-6 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800'>
                        ...
                        <div className='h-56 md:h-64 lg:h-60 xl:h-72 rounded-lg bg-neutral-100 dark:bg-neutral-800 overflow-hidden relative '>
                         ...
                         <div className='absolute bottom-4 right-4'>
                          <div className='w-12 h-12 lg:w-14 lg:h-14 rounded-full bg-gradient-to-r from-amber-500 to-indigo-900 animate-pulse flex items-center justify-center text-white shadow-lg '>
                        ...
                        <div className='mt-3 lg:mt-4 flex justify-between items-center'>
                           <div className='flex gap-2'>
                            ...
                            <button className='w-8 h-8 lg:w-9 lg:h-9 xl:h-10 xl:w-10 rounded-full  bg-amber-500 flex justify-center items-center text-neutral-900 hover:bg-amber-600 transition '>
